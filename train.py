...
def run_parse_args():
    ...
    parser.add_argument("--msmarco_dir", type=str, default=f"./msmarco-doc")
    parser.add_argument("--collection_memmap_dir", type=str, default="./tokenized_collection_memmap")
    parser.add_argument("--tokenize_dir", type=str, default="./tokenize_dir")
    ...
    parser.add_argument("--bert_tokenizer_path", default='./bert-base-uncased', type=str)
...
def main():
    ...
    if args.task == "train":
        ...
        load_model_path = f"{args.model_save_dir}/{args.eval_ckpt}"
    ...
    if args.task == "train":
        ...
        result = evaluate(args, model, args.task, prefix=f"{args.eval_ckpt}")
        end_time = time.time()
        elapsed_time = end_time - start_time
        file_write_obj = open(f"{args.output_dir}/result.log", 'a')
        file_write_obj.write(str(result) + '\t'+ str(elapsed_time) + '\n') 
